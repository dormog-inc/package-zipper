...
import com.github.dormog.packagezipper.models.*;
...
import static com.github.dormog.packagezipper.configuration.RepositoryConfig.GRADLE_PLUGINS_REPOSITORY;
import static com.github.dormog.packagezipper.configuration.RepositoryConfig.MAVEN_REPOSITORY;
...
public class ArtifactResolverService {
    ...
    private ResolvingProcessAetherResult calculateArtifactsList(Artifact originalArtifact,
        ...
        try {
            ...
            if (originalArtifact.getArtifactId().contains(GradlePluginsHandler.GRADLE_PLUGIN)) {
